...
<div class="max-w-[85rem] mx-auto px-4 mt-4 sm:px-6 lg:px-8">
	<!-- Grid -->
	<div class="grid md:grid-cols-2 gap-4 items-center md:gap-8 xl:gap-20">
		...
		<div class="relative ms-4">
			<img
				...
				src="https://www.bcmarinecanvasri.com/images/enclosures/stamoid-bridge-enclosure-interior.jpg"
				alt="Image Description"
			/>
			<div
				class="absolute inset-0 -z-[1] bg-gradient-to-tl from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 -me-4 ms-4 lg:mt-6 lg:-mb-6 lg:-me-6 lg:ms-6 dark:from-neutral-800 dark:via-neutral-900/0 dark:to-neutral-900/0"
			></div>
